package lu.kainovaii.sypercore.example;
...
import lu.kainovaii.sypercore.command.GotoCommand;
import lu.kainovaii.sypercore.example.items.InstantKillItem;
import lu.kainovaii.sypercore.example.teams.BlueTeam;
import lu.kainovaii.sypercore.example.teams.RedTeam;
import lu.kainovaii.sypercore.example.winconditions.NoBluePlayers;
import lu.kainovaii.sypercore.example.winconditions.NoRedPlayers;
import lu.kainovaii.sypercore.foundation.configuration.property.CollectionProperty;
import lu.kainovaii.sypercore.foundation.configuration.property.Property;
import lu.kainovaii.sypercore.foundation.configuration.property.PropertyType;
import lu.kainovaii.sypercore.foundation.registry.RegistryEvent;
